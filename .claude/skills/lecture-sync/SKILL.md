...
3. Find what's already filed: grep `granola_id:` across that class's `lectures/*.md`. Skip any meeting whose id is already there. Never modify an existing lecture file.
